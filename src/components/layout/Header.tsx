...
export default function Header({ onMenuToggle }: HeaderProps) {
  return (
    <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-10 shrink-0 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        {/* 검색창 (데스크톱만) */}
        <div className="hidden md:flex items-center gap-2.5 bg-gray-50 border border-gray-200 rounded-xl px-3.5 py-2 w-72 transition-all focus-within:border-blue-400 focus-within:bg-white focus-within:shadow-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="hidden md:flex w-9 h-9 items-center justify-center rounded-xl hover:bg-gray-100 transition-colors">
        ...
        <div className="flex items-center gap-2.5 pl-1 cursor-pointer">
          ...
          <div className="hidden md:block">
            <p className="text-sm font-semibold text-gray-800 leading-none">관리자</p>
